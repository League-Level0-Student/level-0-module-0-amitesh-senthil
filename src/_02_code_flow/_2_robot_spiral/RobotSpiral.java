...
public class RobotSpiral {
	...
	public static void main(String[] args) {
		...
		// Create a new Robot
		Robot spiral_bobb = new Robot();
		// Set your robot's pen down 
		spiral_bobb.penDown();
		// SPEED. Set the robot to go at max speed (100)
		spiral_bobb.setSpeed(10);
