...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("Type an adjective or I'll hold your family hostage");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Type a liquid or I'll keep your family hostage");
		// Get the player to enter a body part
		String body_part = JOptionPane.showInputDialog("Type a body part or I'll keep your family hostage");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Type a verb or I'll keep your family hostage");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Type a place and I'll let go of your family");
